...
const String kDaysPageTitle = 'Workouts';
const String kWorkoutListTitle = 'Workouts';
...
const String kWorkoutUpdateTrainingPageDescription =
    "After changing the program, don't forget to update it.";
const String kLogoutMessage = "Are you sure you want to log out?";
